...
import com.limitflow.mfarmer.event.FarmEvent;
...
public class MFarmer extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.farmEvent = new FarmEvent(this);
        this.farmEvent.loadConfig();
    ...
    public void onDisable() {
        if (expansion != null) expansion.shutdown();
        if (farmEvent != null) farmEvent.shutdown();
    ...
    public void loadPluginConfig() {
        ...
        if (farmEvent != null) farmEvent.loadConfig();
    }
    ...
    public FarmEvent getFarmEvent()         { return farmEvent; }
}
